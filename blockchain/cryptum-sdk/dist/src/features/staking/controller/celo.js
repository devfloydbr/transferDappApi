...
const { CELO_ACCOUNTS_ADDRESS, Protocol, CELO_ELECTION_ADDRESS, CELO_LOCKEDGOLD_ADDRESS, } = require('../../../services/blockchain/constants');
...
class CeloStakingController extends Interface {
    ...
    async _findLesserGreater({ amount, validator, network }) {
        ...
        const voteTotal = selectedValidatorIndex > -1
            ? new BigNumber(currentVotes.values[selectedValidatorIndex]).plus(amountWei)
            : amountWei;
        let lesser = '0x0000000000000000000000000000000000000000', greater = '0x0000000000000000000000000000000000000000';
