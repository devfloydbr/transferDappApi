...
class StellarTransferTransactionInput extends TransferTransactionInput {
     ...
     */
    constructor(_a) {
        var { assetSymbol, createAccount, issuer } = _a, args = __rest(_a, ["assetSymbol", "createAccount", "issuer"]);
        super(args);
        this.assetSymbol = assetSymbol;
...
class RippleTransferTransactionInput extends TransferTransactionInput {
     ...
     */
    constructor(_a) {
        var { assetSymbol, issuer } = _a, args = __rest(_a, ["assetSymbol", "issuer"]);
        super(args);
        this.assetSymbol = assetSymbol;
        this.issuer = issuer;
    }
...
class EthereumTransferTransactionInput extends TransferTransactionInput {
     ...
     */
    constructor(_a) {
        var { tokenSymbol, contractAddress } = _a, args = __rest(_a, ["tokenSymbol", "contractAddress"]);
        super(args);
...
class CeloTransferTransactionInput extends EthereumTransferTransactionInput {
     ...
     */
    constructor(_a) {
        var { feeCurrency } = _a, args = __rest(_a, ["feeCurrency"]);
        super(args);
...
class BitcoinTransferTransactionInput extends TransferTransactionInput {
     ...
     */
    constructor(_a) {
        var { outputs, inputs } = _a, args = __rest(_a, ["outputs", "inputs"]);
        super(args);
