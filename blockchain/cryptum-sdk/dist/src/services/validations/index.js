...
module.exports.validateEthereumTransferTransactionParams = ({ wallet, tokenSymbol, amount, destination, fee, testnet, contractAddress, }) => {
    if (!wallet) {
...
module.exports.validateCeloTransferTransactionParams = ({ wallet, tokenSymbol, amount, destination, memo, fee, testnet, contractAddress, feeCurrency, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (tokenSymbol && typeof tokenSymbol !== 'string') {
...
module.exports.validateSmartContractTransactionParams = ({ wallet, fee, testnet, contractAddress, feeCurrency, protocol, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && (!fee.gas || !fee.gasPrice)) {
...
module.exports.validateSmartContractDeployTransactionParams = ({ wallet, fee, testnet, source, contractName, params, feeCurrency, protocol, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && (!fee.gas || !fee.gasPrice)) {
...
module.exports.validateTokenDeployTransactionParams = ({ wallet, fee, testnet, tokenType, params, feeCurrency, protocol, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && (!fee.gas || !fee.gasPrice)) {
...
module.exports.validateBitcoinTransferTransactionParams = ({ wallet, inputs, outputs }) => {
    ...
    if (inputs && (!Array.isArray(inputs) || !inputs.length)) {
        throw new GenericException('Invalid parameter inputs, it should be an array with length larger than 0', 'InvalidTypeException');
    }
    if (!Array.isArray(outputs) || !outputs.length) {
        throw new GenericException('Invalid parameter outputs, it should be an array with length larger than 0', 'InvalidTypeException');
    }
};
...
module.exports.validateHathorTokenTransactionFromWallet = ({ wallet, tokenUid, tokenName, tokenSymbol, address, changeAddress, mintAuthorityAddress, meltAuthorityAddress, amount, type, }) => {
    if (!wallet) {
        throw new GenericException('Parameter wallet is null', 'InvalidTypeException');
    }
    if (![
...
module.exports.validateHathorTokenTransactionFromUTXO = ({ inputs, tokenUid, tokenName, tokenSymbol, address, changeAddress, mintAuthorityAddress, meltAuthorityAddress, amount, type, }) => {
    if (!inputs) {
        throw new GenericException('Parameter inputs is null', 'InvalidTypeException');
    }
    if (inputs && (!Array.isArray(inputs) || !inputs.length)) {
...
module.exports.validateStellarTransferTransactionParams = ({ wallet, assetSymbol, issuer, amount, destination, memo, fee, testnet, createAccount, timeout, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
...
module.exports.validateRippleTransferTransactionParams = ({ wallet, assetSymbol, issuer, amount, destination, memo, fee, testnet, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && typeof fee !== 'string') {
...
module.exports.validateStellarTrustlineTransactionParams = ({ wallet, assetSymbol, issuer, fee, limit, memo, timeout, testnet, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && typeof fee !== 'string') {
...
module.exports.validateRippleTrustlineTransactionParams = ({ wallet, assetSymbol, issuer, fee, limit, memo, testnet, }) => {
    if (!wallet) {
        throw new GenericException('Invalid wallet', 'InvalidTypeException');
    }
    if (fee && typeof fee !== 'string') {
