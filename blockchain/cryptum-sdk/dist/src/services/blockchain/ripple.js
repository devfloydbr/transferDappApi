 ...
 */
module.exports.buildRippleTrustlineTransaction = async function ({ fromAddress, fromPrivateKey, sequence, maxLedgerVersion, assetSymbol, issuer, limit = null, memo = null, fee = null, }) {
 ...
 * @returns {Promise<string>} signed tx
 */
module.exports.buildRippleTransferTransaction = async function ({ fromAddress, fromPrivateKey, sequence, maxLedgerVersion, assetSymbol, issuer, amount, destination, memo = null, fee = null, }) {
    const rippleAPI = new RippleAPI();
    const transfer = {
        source: {
            address: fromAddress,
