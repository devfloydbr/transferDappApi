 ...
 */
module.exports.buildStellarTrustlineTransaction = async function ({ fromPublicKey, fromPrivateKey, sequence, assetSymbol, issuer, fee, limit = null, memo = null, testnet = true, }) {
 ...
 * @returns {Promise<string>} signed tx
 */
module.exports.buildStellarTransferTransaction = async function ({ fromPublicKey, fromPrivateKey, sequence, assetSymbol, issuer, amount, destination, createAccount = false, fee, memo = null, testnet = true }) {
    const account = new StellarSdk.Account(fromPublicKey, sequence);
